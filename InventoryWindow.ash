...
import function btnInvWinClose_OnClickHandler(GUIControl *control, MouseButton button);
import function btnInvWinUp_OnClickHandler(GUIControl *control, MouseButton button);
